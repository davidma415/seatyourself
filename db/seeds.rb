...
r1 = Restaurant.create!(name: "BK", opening_hour: "2000-01-01 08:30:00", closing_hour: "2000-01-01 23:30:00", address: "123 Apple Street", price_range: "$", max_capacity: 45, user_id: u1.id, min_party_size: 1, max_party_size: 10)
r2 = Restaurant.create!(name: "McD", opening_hour: "2000-01-01 08:30:00", closing_hour: "2000-01-01 23:30:00", address: "22 Jump Street", price_range: "$$", max_capacity: 35, user_id: u2.id, min_party_size: 2, max_party_size: 20)
